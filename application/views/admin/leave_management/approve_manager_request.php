                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <?php }
                                                                        ...
                                                                        <p>Rejected</p>
                                                                    <?php }
                                                                    else if(empty($approve_leave['status_1']) && empty($approve_leave['status'])) {?>
                                                                        <a href="<?php echo base_url('admin/leave_management/approve_manager/'.$approve_leave['id'])?>" class="btn btn-success" onclick="return confirm('Are you sure want to Approve this Vacation?')">Approve</a> <a href="<?php echo base_url('admin/leave_management/reject_manager/'.$approve_leave['id'])?>" class="btn btn-danger">Reject</a>
                                                                    <?php }?>
                                                                </td>
