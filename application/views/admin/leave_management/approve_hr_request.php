                                                    ...
                                                    <tbody>
                                                        ...
                                                        <?php foreach($approve as $approve_leave) :?>
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if ($approve_leave['status_2'] == '1'){
                                                                    ?>
                                                                    <p>Approved</p>
                                                                    <?php }
                                                                    else if($approve_leave['status_2'] == '0') {?>
                                                                        <p>Rejected</p>
                                                                    <?php }
                                                                    else if(empty($approve_leave['status_2'] )) {?>
                                                                        <a href="<?php echo base_url('admin/leave_management/approve_hr/'.$approve_leave['id'])?>" class="btn btn-success" onclick="return confirm('Are you sure want to Approve this Vacation?')">Approve</a> <a href="<?php echo base_url('admin/leave_management/reject_hr/'.$approve_leave['id'])?>" class="btn btn-danger">Reject</a>
                                                                    <?php }?>
                                                                </td>
