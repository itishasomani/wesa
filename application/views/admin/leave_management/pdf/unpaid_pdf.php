            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene  <?php echo date('d-m-Y',strtotime($l_from));?> -ci il tarixinden 05.01.2021-ci il tarixinedek, ise baslama tarixi 06.01.2021-ci il teyin olunsun, <?php echo $days;?>  teqvim gunu oz hesabima odenissiz mezuniyyete cixmagima icaze veresiniz. 
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission for unpaid vacation at my own expense from  <?php echo date('d-m-Y',strtotime($l_from));?>  to <?php echo date('d-m-Y',strtotime($l_to));?>  for  <?php echo $days;?>  calendar days, date of going back to work should be considered from <?php echo date('d-m-Y',strtotime($back_to));?>. 
                            </td>
                        </tr>
                    </table>
                </div>
