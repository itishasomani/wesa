        ...
        <div class="row">
            <div class="float-right pdf_header">
                <div class="text-end">
                    ...
                    <p class="text"><?php echo get_emp_by_id($approver2)['name']?> <?php echo get_emp_by_id($approver2)['surname']?> Nizameddin ogluna</p>
                    <br>
                    <p class="text"> <?php echo $f_name;?> <?php echo $surname;?> oglu/qizi</p>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene <?php echo date('d-m-Y',strtotime($l_from));?> -ci il tarixinden <?php echo $days;?> teqvim gunu emek mezuniyyetine cixmagima icaze veresiniz. 
                            </td>
                        </tr>
                        <tr>
                            <td>Hemcinin, menim <?php echo date('d-m-Y',strtotime($l_from));?> - <?php echo date('d-m-Y',strtotime($l_to));?> tarixlerinde nezerde tutulan emek mezuniyyeti haqqimi ayin sonunda emek haqqi ile birlikde odenilmesine icaze veresiniz.</td>
                        </tr>
                    </table>
                </div>
            </div>
    ...
    <section class="container-flud">
        <div class="row">
            <div class="float-right section_2_pdf">
                <div class="text-end">
                    <p>To <?php echo get_emp_by_id($approver2)['name']?> <?php echo get_emp_by_id($approver2)['surname']?></p>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission for vacation from  <?php echo date('d-m-Y',strtotime($l_from));?>  for <?php echo $days;?> calendar days. 
                            </td>
                        </tr>
                        <tr>
                            <td>I also ask for payment of my leave welfare allowance due to the vacation for  <?php echo date('d-m-Y',strtotime($l_from));?> - <?php echo date('d-m-Y',strtotime($l_to));?>  together with my salary at the end of the month.</td>
                        </tr>
                    </table>
                </div>
            </div>
