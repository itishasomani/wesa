        ...
        <div class="row">
            <div class="container">
                <div class="pdf_body">
                    ...
                    <h6 style="font-style: italic;">Ezamiyyetin tefsilati:</h6>
                    ...
                    <table class="tableborder" style="border:1px solid; width:100%">
                        ...
                        <tbody style="border:1px solid #000; width:100%">
                            ...
                            <tr>
                                <td style="font-style: italic;"><strong>elaveler:</strong></td>
                                <td></td>
                                <td></td>
                                <td></td>
                            </tr>
                    ...
                    <table class="tableborder" style="border:1px solid; width:100%">
                        <thead>
                            <tr>
                                <th style="font-style: italic;"><strong>Direktor <br> Habib Atakisiyev</strong></th>
                                <th style="font-style: italic;"><strong>IR Menecer <br> Kamran eliyev</strong></th>
                                <th style="font-style: italic;"><strong>Bas Muhasib <br> Kamran eliyev</strong></th>
                                <th style="font-style: italic;"><strong>Isci (Ezamiyyete geden) <br> <?php echo $f_name?> <?php echo $surname?></strong></th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
