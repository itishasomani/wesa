            ...
            <div class="container-fluid">
                ...
                <div class="d-flex flex-wrap justify-content-between align-items-end">
                    <form method="post" action="" id="filterForm" class="d-flex flex-wrap align-items-end mb-4">
                        ...
                        <button type="submit" name="action" value="csv" class="btn btn-primary ml-2">CSV Download</button>
                    </form>
                                                ...
                                                <?php $i = 1; ?>
                                                    <?php foreach($leave_detail as $leave): ?>
                                                        <tr class="odd">
                                                            ...
                                                            <td >
                                                                <a href="<?php echo base_url('admin/leave_management/edit_leave_management/'.$leave['id'])?>" class="btn btn-success" style="margin:3px;">
                                                                    <i class="far fa-edit"></i>
                                                                </a>
                                                                
                                                                <a href="<?php echo base_url('admin/leave_management/delete_leave_management/'.$leave['id'])?>" class="btn btn-danger" style="margin:3px;" onclick="return confirm('Are you sure you want to delete?')">
                                                                    <i class="far fa-trash-alt"></i>
                                                                </a>
                                                                <?php if ($leave['status'] == '1' && $leave['status_2'] == '1' && $leave['status_1'] == 'Approve' ){
                                                                ?>
                                                                <a href="<?php echo base_url('admin/leave_management/download_pdf/'.$leave['id'])?>" class="btn btn-primary" target="_blank" style="margin:3px;">
                                                                    <i class="fa fa-file-pdf"></i>
                                                                </a>
                                                                <a href="<?php echo base_url('admin/leave_management/pdf/'.$leave['id'])?>" class="btn btn-primary" target="_blank" style="margin:3px;">
                                                                    <i class="fa fa-file-pdf"></i>
                                                                </a>
                                                                <?php if($leave['leave_type'] =="Business Trip" || $leave['leave_type'] =="Maternity Leave"){?>
                                                                    <a href="<?php echo base_url('admin/leave_management/waybillpdf/'.$leave['id'])?>" class="btn btn-primary" target="_blank" style="margin:3px;"> 
                                                                        <i class="fa fa-file-pdf"></i>
                                                                    </a>
                                                                <?php }?>
                                                                <?php }?>
