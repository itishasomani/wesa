                                ...
                                <form method="post" action="<?php echo base_url('admin/leave-management-edit');?>" id="editLeavemanagement" enctype="multipart/form-data">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="exampleInputApprover" name="manager" class="form-control" readonly>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select id="exampleInputApprover" name="approver_two" class="form-control" readonly>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="<?php echo base_url('admin/leave-management');?>" class="btn btn-primary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
