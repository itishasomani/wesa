                                ...
                                <form method="post" action="<?php echo base_url('admin/add_procurement');?>" id="Procurement" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <?php if(($_SESSION['emp_type']) == '6' || ($_SESSION['emp_type']) == '5' || ($_SESSION['emp_type']) == '2' || ($_SESSION['emp_type']) == '3'){?>
                                        ...
                                        <!--<div class="form-group">-->
                                        <!--<label for="exampleInputApprover">Additional Approver (Director) </label>-->
                                        <!--    <select name="approver_three" id="approver_three" multiple class="form-control input-lg">-->
                                        <!--        <?php foreach($director as $director):?>-->
                                        <!--            <option value="<?= $director['id']?>"><?php echo $director['name']?> <?php echo $director['surname']?></option>-->
                                        <!--        <?php endforeach;?>-->
                                        <!--    </select>-->
                    ...
                    success:function(data)
                    {
                        var data = JSON.parse(data);
                            ...
                            for (var i = 0; i < data.length; i++) 
                            {
                                ...
                                html2 +=  '<option value="'+data[i].sub_category+'">'+data[i].sub_category+'</option>';
                            }
                        $('#b_category').html(html);
                        $('#sub_category').html(html2);
                        if(data == ""){
    ...
    function getFileNameWithExt(event) {
      ...
      const ext = name.substring(lastDot + 1);
        if(ext == 'jpg' || ext == 'png' || ext == 'jpeg' || ext == 'pdf'){
            $(".input-group").after(fileName + '<p class="text-success">File added Successfully</p>');
            $(".text-danger ").css('display','none');
        }
        else{
            $(".input-group").after('<p class="text-danger">Invalid Image (* please choose jpg, png , jpeg,pdf)</p>');
