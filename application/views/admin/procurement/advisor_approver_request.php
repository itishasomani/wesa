                                                                ...
                                                                <td>
                                                                   <?php if($req['status_1'] == '1') { ?>
                                                                    ...
                                                                    <?php }
                                                                        ...
                                                                        <a href="<?php echo base_url('admin/procurement/approveprocurement/'.$req['id'])?>" class="btn btn-success" id="yes">Approve</a> <a href="<?php echo base_url('admin/procurement/rejectprocurement/'.$req['id'])?>" class="btn btn-danger" id="no">Reject</a>
                                                                    <?php }
                                                                    ?>
                                                                </td>
                                                                <!--<td>-->
