                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="<?php echo base_url('admin/procurement')?>">Home</a></li>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    ...
                                                    <input type="file" name="featuredImage" class="custom-file-input" id="exampleInputAttachment" onChange='getFileNameWithExt(event)' value="<?php echo $procurement['featuredImage']?>">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            ...
                                            <select name="supplier[]" id="supplier" class="form-control input-lg" multiple>
                                                <?php foreach($vendor as $vendor):?>
                                                    <option value="<?=$vendor['v_name']?>"><?=$vendor['v_name']?></option>
                                                <?php endforeach?>
                                            </select>
                                        </div>
                                         <div class="form-group">
                                            <label for="exampleInputComment">Quotation (please add link to server location where files are uploaded)</label>
                                            <input type="text" name="qutation" class="form-control" id="exampleInputprice" placeholder="Quotation">
                                        </div>
                                        <!-- <div class="form-group">-->
                                        <!--    <label for="exampleInputComment">Add approver</label>-->
                                        <!--    <input type="text" name="add_approver" class="form-control" id="exampleInputprice" placeholder="Add approver">-->
                                        <!--</div>-->
                                        <div class="form-group">
                                            <label for="exampleInputApprover">Add approver</label>
                                            <select name="add_approver" id="add_approver" class="form-control input-lg">
                                                <option value="Select Add Approver">Select Add Approver</option>
                                                <option></option>
                                            </select>
                                        </div>
                                        <!--<div class="form-group">-->
                 ...
                 success:function(data){
                     ...
                     var value = '';
                        ...
                        for(i=0; i<data.length; i++){
                            html = '<option value="">Select Add Approver</option>';
                            html1 = '<option value="none">None</option>';
                            html2 += '<option value="'+data[i].id+'" >'+data[i].name+' '+data[i].surname+'</option>';
                            value = html + html1 + '<br>' + html2;
                        }
                     $('#add_approver').html(value);
                 }
             });
         }
         else
