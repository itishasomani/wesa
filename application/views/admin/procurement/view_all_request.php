                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="request" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                    <thead>
                                                        <tr role="row">
                                                    ...
                                                    ?>
                                                        ...
                                                        <td class="dtr-control" tabindex="0"><?php echo $i++;?></td>
                                                            ...
                                                            <td>
                                                                <?php if($req['complete'] == 'completed'){?>
                                                                    ...
                                                                    <?php }
                                                                        ...
                                                                        <a href="<?php echo base_url('admin/procurement/request_yes/'.$req['id'])?>" class="btn btn-success" id="yes">Yes</a> <a href="<?php echo base_url('admin/procurement/request_no/'.$req['id'])?>" class="btn btn-danger" id="no">No</a>
                                                                    <?php }
                                                                    ?>
                                                                <?php }else{?>
                                                                    <a>Pending</a>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="<?php echo base_url('admin/procurement/duplicate/'.$req['id'])?>" class="btn btn-primary">
