                        ...
                        <div class="col-sm-6 col-md-6 mb-1">
                            <div class="info-box p-3">
                                ...
                                <div class="info-box-content pl-3">
                                    ...
                                    <h6 class="text p-1"><span class="text-bold">Current Owner :</span> <?php echo $asset['c_owner'];?></h6>
                                ...
                                <div class="info-box-icon_">
                                    ...
                                    <a href="<?php echo base_url('admin/assets/delete_assets/'.$asset['id'])?>" class="btn btn-danger">
