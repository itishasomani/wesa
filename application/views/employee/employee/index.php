                    ...
                    <div class="form-group d-flex">
                        ...
                        <div style="width:16%;position:relative;">
                            <select class="form-control" name="title" id="employee">
                                ...
                                <?php $title = $this->employee_model->title_group();?>
                    ...
                    <?php if(!empty($employees)):?>
                        <?php foreach($employees as $employee): ?>
                               ...
                               <?php
                                    ...
                                    if ((($currentDate > $startDate && $currentDate < $endDate) || ($currentDate > $startDate && $currentDate == $endDate)||($currentDate == $startDate && $currentDate < $endDate)) && $name == $employee['name']){
