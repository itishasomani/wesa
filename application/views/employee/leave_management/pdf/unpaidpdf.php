            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. Azerbaycan Respublikasinin Emek Mecellesinin 128-ci maddesine esasen “VVESA” MMC-nin emekdasi <?php echo $f_name;?> <?php echo $surname;?> <?php echo date('d-m-Y',strtotime($l_from));?>-ci il tarixinden <?php echo date('d-m-Y',strtotime($l_to));?>-ci is ili ucun <?php echo $days;?> teqvim günü oz hesabina odenissiz mezuniyyete buraxilsin.</p>
                                <p>2.  <?php echo $f_name;?> <?php echo $surname;?> qizinin erizesine esasen oz hesabina odenissiz mezuniyyet verilsin</p>
                        ...
                        <tr>
                            <td>
                                <p>Esas : <?php echo $f_name;?> <?php echo $surname;?>  oglu/qizi  <?php echo date('d-m-Y',strtotime($date));?> -ci il tarixli erizesi</p>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <div class="pdf_body">
                    ...
                    <table>
                        <tr>
                            ...
                            <div style="float:right;padding-top:35px;"><strong><?php echo date('d-m-Y',strtotime($approve_date));?></strong></div>
                        </tr>
                    </table>
                    <table>
                        <tr>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. <?php echo $f_name;?> <?php echo $surname;?> employee of “VVESA” LLC, should be granted unpaid leave at her own expense for  <?php echo $days;?> calendar days from <?php echo date('d-m-Y',strtotime($l_from));?> to <?php echo date('d-m-Y',strtotime($l_to));?>  in accordance with the Article 128 of the Labor Code of the Republic of Azerbaijan.</p>
                                <p>2. <?php echo $f_name;?> <?php echo $surname;?>  should be granted unpaid leave at her own expense.</p>
                        ...
                        <tr>
                            <td>
                                <p>Basis :  <?php echo $f_name;?> <?php echo $surname;?>'s application dated  <?php echo date('d-m-Y',strtotime($date));?> .</p>
                            </td>
                        </tr>
                    </table>
                </div>
        ...
        <div class="row">
            <div class="container">
                <div class="pdf_footer">
                    ...
                    <tr>
                        <td>
                            Director of “VVESA” LCC:	             _____________________ Atakisiyev H.N.
                        </td>
                    </tr>
                    <tr>
                        <td>
