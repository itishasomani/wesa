            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib sizden xahis edirem ki, meni <?php echo date('d-m-Y',strtotime($l_from));?> -ci il tarixinden  <?php echo date('d-m-Y',strtotime($l_to));?> -ci il tarixinedek <?php echo $days;?> (bir yuz iyirmi alti) teqvim gunu muddetine hamileliye ve dogusa gore sosial mezuniyyete buraxarsiniz.
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask social leave in connection with maternity from  <?php echo date('d-m-Y',strtotime($l_from));?> to  <?php echo date('d-m-Y',strtotime($l_to));?> for  <?php echo $days;?>  calendar days. 
