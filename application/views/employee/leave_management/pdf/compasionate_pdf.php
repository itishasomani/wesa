            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene  <?php echo date('d-m-Y',strtotime($l_from));?>  -ci il tarixinden <?php echo $days;?> teqvim gunu sebeb: <?php echo $comment;?> gore cixmagima icaze veresiniz.  
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission in connection with ________________ from  <?php echo date('d-m-Y',strtotime($l_from));?>  only for  <?php echo $days;?>  calendar days .  
                            </td>
                        </tr>
                    </table>
                </div>
