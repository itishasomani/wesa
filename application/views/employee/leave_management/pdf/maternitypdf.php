            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. Azerbaycan Respublikasinin emek Mecellesinin 125-ci maddesine esasen “VVESA” MMC-nin emekdasi <?php echo $f_name ?> <?php echo $surname?> <?php echo date('d-m-Y',strtotime($l_from));?>-ci il tarixinden <?php echo date('d-m-Y',strtotime($l_to));?>-ci is ili ucun <?php echo $days;?> tarixinedek 126 (bir yuz iyirmi alti) teqvim gunu muddetine hamileliye ve dogusa gore sosial mezuniyyet verilsin.</p>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <p>Esas : <?php echo $f_name;?> <?php echo $surname;?> <?php echo date('d-m-Y',strtotime($date));?>-ci il tarixli erizesi ve ___.____.______- ci il tarixde verilmis No _____________ sayli emek qabiliyyetinin olmamaq vereqesi. </p>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        <tr class="text-center" >
                            <td>
                                <strong style="font-size:15px;text-align:center">ORDER No: </strong>
                            </td>
                    ...
                    <table>
                        <tr>
                            <div style="float:left;padding-top:35px;"><strong>Baku city</strong></div>
                            <div style="float:right;padding-top:35px;"><strong><?php echo $approve_date?></strong></div>
                        </tr>
                    </table>
                    <table>
                        <tr>
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. According to the Article 125 of the Labor Code of the Republic of Azerbaijan, <?php echo $f_name ?> <?php echo $surname?>  employee of “VVESA” LLC, should be granted social leave for <?php echo $days;?> calendar days from  <?php echo date('d-m-Y',strtotime($l_from));?> to <?php echo date('d-m-Y',strtotime($l_to));?> in connection with maternity.</p>
                            </td>
                        </tr>
                        <!--<tr>-->
                        <!--    <td>-->
                        ...
                        <!--<tr>-->
                        <!--    <td>-->
                        <!--        <p>Esas : <strong><?php echo $f_name;?> <?php echo $surname;?> <?php echo date('d-m-Y',strtotime($date));?></strong>-ci il tarixli erizesi ve ___.____.______- ci il tarixde verilmis No _____________ sayli emek qabiliyyetinin olmamaq vereqesi. </p>-->
                        <!--    </td>-->
                        <!--</tr>-->
                    </table>
                </div>
