            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong>-ci il tarixinden <strong><?php echo $r_days;?></strong> teqvim gunu emek mezuniyyetine cixmagima icaze veresiniz. 
                            </td>
                        </tr>
                        <tr>
