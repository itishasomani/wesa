                ...
                <div class="pdf_body">
                    <table class="table">
                        <tr class="text-center">
                               <h5 style="border-bottom:0.8px solid #0000FF; padding-bottom:10px"><strong>AZ1007, Baki s., Nesimi rayonu, Q.Quliyev kuc. 35, ev 60, m. 4</strong></h5>
                        </tr>
                    </table>
                    <table class="table">
                        <tr>
                            <div style="float:left;padding-top:35px;"><h6><strong>No. </strong></h6></div>
                            <div style="float:right;padding-top:35px;"><h6><strong><?php echo $approve_date?>-ci il</strong></h6></div>
                        </tr>
                    </table>
                    <table class="table">
                        <tr class="text-center" >
                           <h5 style="padding-top:5%;"><strong>PROTOKOL</strong></h5>
                        </tr>
                    </table>
                    <table class="Table">
                        <thead>
                    ...
                    <table class="table">
                        <tr>
                            <div style="float:right; font-size:12px; padding-left:10px"><strong>
                    ...
                    <table class="table" style="padding-top:7%;font-size:15px;padding-bottom:0px">
                        <tr>
