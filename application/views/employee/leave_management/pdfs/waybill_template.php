        ...
        <div class="row">
            <div class="container">
                <div class="pdf_body">
                    ...
                    <h6 style="text-align:center;">Teqdim olunan senedler</h6>
                    <table class="tableborder" style="border:1px solid; width:100%">
                        <thead>
                            <tr>
                                <th>Xercin teyinati:</th>
                                <th>Aciqlama</th>
                                <th>Tesdiqedici sened</th>
                                <th>Mebleg</th>
                            </tr>
                        </thead>
                        <tbody style="border:1px solid #000; width:100%">
                    ...
                    <h6 style="text-align:center;">Tesdiq eden sexsler</h6>
                    <table class="tableborder" style="border:1px solid; width:100%">
                        <thead>
                            <tr>
                                <th>Direktor <br> Habib Atakisiyev</th>
                                <th>IR Menecer <br> Kamran eliyev</th>
                                <th>Bas Muhasib <br> Kamran eliyev</th>
                                <th>Isci (Ezamiyyete geden) <br> <?php echo $f_name?> <?php echo $surname?></th>
                            </tr>
                        </thead>
                    </table>
                    <table>
