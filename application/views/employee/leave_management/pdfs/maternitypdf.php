            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>Esas : <strong><?php echo $f_name;?> <?php echo $surname;?> <?php echo $date?></strong>-ci il tarixli erizesi ve ___.____.______- ci il tarixde verilmis No _____________ sayli emek qabiliyyetinin olmamaq vereqesi. </p>
                            </td>
                        </tr>
                    </table>
                </div>
