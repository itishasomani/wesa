            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> -ci il tarixinden <strong> <?php echo $days;?> </strong> teqvim gunu sebeb: <strong> <?php echo $comment;?> </strong> gore cixmagima icaze veresiniz.  
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission in connection with ________________ from <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> only for <strong> <?php echo $days;?> </strong> calendar days<strong> .  
                            </td>
                        </tr>
                    </table>
                </div>
