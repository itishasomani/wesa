            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. According to the Article 125 of the Labor Code of the Republic of Azerbaijan,  <strong><?php echo $f_name ?> <?php echo $surname?> </strong> employee of “VVESA” LLC, should be granted social leave for  <strong><?php echo $days;?></strong> calendar days from <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> to <strong><?php echo date('d-m-Y',strtotime($l_to));?></strong>in connection with maternity.</p>
                            </td>
                        </tr>
                        <!--<tr>-->
                        <!--    <td>-->
