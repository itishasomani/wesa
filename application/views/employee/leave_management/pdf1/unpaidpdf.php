            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>Esas : <strong><?php echo $f_name;?> <?php echo $surname;?> </strong> oglu/qizi <strong> <?php echo date('d-m-Y',strtotime($date));?></strong>-ci il tarixli erizesi</p>
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    ...
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                <p>1. <strong> <?php echo $f_name;?> <?php echo $surname;?> </strong> employee of “VVESA” LLC, should be granted unpaid leave at her own expense for <strong> <?php echo $days;?> </strong> calendar days from <strong><?php echo date('d-m-Y',strtotime($l_from));?> to <?php echo date('d-m-Y',strtotime($l_to));?> </strong> in accordance with the Article 128 of the Labor Code of the Republic of Azerbaijan.</p>
                                <p>2. <strong> <?php echo $f_name;?> <?php echo $surname;?> </strong> should be granted unpaid leave at her own expense.</p>
                        ...
                        <tr>
                            <td>
                                <p>Basis :  <strong><?php echo $f_name;?> <?php echo $surname;?> </strong>'s application dated  <strong> <?php echo date('d-m-Y',strtotime($date));?></strong> .</p>
                            </td>
                        </tr>
                    </table>
                </div>
