            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Sizden xahis edirem ki, mene <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> -ci il tarixinden 05.01.2021-ci il tarixinedek, ise baslama tarixi 06.01.2021-ci il teyin olunsun, <strong> <?php echo $days;?> (bes) </strong> teqvim gunu oz hesabima odenissiz mezuniyyete cixmagima icaze veresiniz. 
                            </td>
                        </tr>
                    </table>
                </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission for unpaid vacation at my own expense from <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> to <strong> <?php echo date('d-m-Y',strtotime($l_to));?> </strong> for <strong> <?php echo $days;?> </strong> calendar days, date of going back to work should be considered from <strong> <?php echo date('d-m-Y',strtotime($back_to));?>. </strong> 
                            </td>
                        </tr>
                    </table>
                </div>
