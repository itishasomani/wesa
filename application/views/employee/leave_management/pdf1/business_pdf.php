        ...
        <div class="row">
            <div class="float-right pdf_header">
                <div class="text-end">
                    ...
                    <p><strong> <?php echo get_emp_by_id($approver2)['name']?> <?php echo get_emp_by_id($approver2)['surname']?></strong> Nizameddin ogluna</p>
                    <br>
                    <p> <strong> <?php echo $f_name;?> <?php echo $surname;?></strong> oglu/qizi</p>
                    <p>terefinden</p>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib Size bildirmek isteyirem ki, <strong> purpose of BT </strong>, bunula bagli meni <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> il tarixinden <strong> <?php echo date('d-m-Y',strtotime($l_to));?> </strong> il tarixinedek cemi <strong> <?php echo $days;?> </strong> teqvim gunu muddetine Baki (Azerbaycan) seherine, 
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask permission in connection with a business trip to Baku city (Azerbaijan) for the purpose of _________________ from <strong> <?php echo date('d-m-Y',strtotime($l_from));?> to <?php echo date('d-m-Y',strtotime($l_to));?> </strong> only for  <strong> <?php echo $days;?> </strong> calendar days.
                            </td>
                        </tr>
                    </table>
                </div>
