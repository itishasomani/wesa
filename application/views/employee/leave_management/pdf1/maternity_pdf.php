            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                Yazib sizden xahis edirem ki, meni <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong>-ci il tarixinden <strong> <?php echo date('d-m-Y',strtotime($l_to));?> </strong>-ci il tarixinedek <strong> <?php echo $days;?> </strong> (bir yuz iyirmi alti) teqvim gunu muddetine hamileliye ve dogusa gore sosial mezuniyyete buraxarsiniz.
    ...
    <section class="container-flud">
        <div class="row">
            <div class="float-right section_2_pdf">
                <div class="text-end">
                    <p>To Atakishiyev <strong> <?php echo get_emp_by_id($approver2)['name']?> <?php echo get_emp_by_id($approver2)['surname']?></strong></strong></p>
            ...
            <div class="container">
                <div class="pdf_body">
                    <table class="table">
                        ...
                        <tr>
                            <td>
                                I, hereby kindly ask social leave in connection with maternity from  <strong> <?php echo date('d-m-Y',strtotime($l_from));?> </strong> to <strong> <?php echo date('d-m-Y',strtotime($l_to));?> </strong>for <strong> <?php echo $days;?> </strong> calendar days. 
