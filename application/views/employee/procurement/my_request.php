            ...
            <section class="content">
                <div class="container-fluid">
                    ...
                    <div class="d-flex justify-content-end mb-2">
                        <a href="<?php echo base_url('employee/add_procurement'); ?>" class="btn btn-dark">Add</a>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <!-- /.card -->
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <table id="procurment" class="table table-bordered table-striped dataTable dtr-inline" role="grid" aria-describedby="example1_info">
                                                    <thead>
                                                        <tr role="row">
                                                    ...
                                                    <?php foreach($request as $req):?>
                                                        ...
                                                        <td class="dtr-control" tabindex="0"><?php echo $i++;?></td>
                                                            <td>
                                                                <a href="<?php echo base_url('admin/procurement/show_procurement/'.$req['id'])?>" style="color:inherit">
                                                                    <?php echo $req['task']?>
                                                                </a>
                                                            </td>
                                                            ...
                                                            <td>
                                                                <?php if($req['name'] == $_SESSION['id']){?>
                                                                    ...
                                                                    <?php }
                                                                        ...
                                                                        <a href="<?php echo base_url('employee/procurement/request_yes/'.$req['id'])?>" class="btn btn-success" id="yes">Yes</a> <a href="<?php echo base_url('employee/procurement/request_no/'.$req['id'])?>" class="btn btn-danger" id="no">No</a>
                                                                    <?php }
                                                                    ?>
                                                                <!--<?php }?>-->
                                                            </td>
                                                            <td>
                                                                <a href="<?php echo base_url('employee/procurement/edit_procurement/'.$req['id'])?>" class="btn btn-success">
                                                                    <i class="far fa-edit"></i>
                                                                </a>
                                                                <a href="<?php echo base_url('employee/procurement/duplicate/'.$req['id'])?>" class="btn btn-primary">
