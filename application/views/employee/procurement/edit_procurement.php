                ...
                <div class="row justify-content-center align-items-center">
                        <div class="col-lg-6">
                            <div class="card card-primary">
                                <!-- form start -->
                                <form method="post" action="<?php echo base_url('employee/procurement_edit');?>" id="editProcurement" enctype="multipart/form-data">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <div class="form-group">
                                            <input type="hidden" id="exampleInputName" name="role" value="admin" class="form-control" placeholder="Role">
                                            ...
                                            <?php $emp = $this->employee_model->get_name();?>
                                                <select name="name" id="Name" class="form-control input-lg" readonly style="-webkit-appearance: none;">
                                            ...
                                            <select name="task" id="task" class="form-control input-lg">
                                                <option value="Task">Task</option>
                                                 <?php foreach($tasks as $task):?>
                                                    <option <?php if($procurement['task'] == $task['id']){echo 'selected';}?> value="<?=$task['id']?>"><?=$task['task_name']?></option>
                                                <?php  endforeach?>
                                            </select>
                                        </div>
                                        <!--<div class="form-group">-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="sub_category" id="sub_category" class="form-control input-lg">
                                                <option value="Budget SubCategory">Budget Sub Category</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                   <!--<img src="<?php echo base_url('assets/backend/dist/img/')?><?php echo $procurement['featuredImage']?>" alt="Image" class="media-object img-rounded thumb48" style="width: 10%;position: absolute;right: 0;">-->
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="<?php echo base_url('employee/procurement')?>" class="btn btn-primary">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
...
<script>
    ...
    //             {
    //                 $.ajax({
    //                     url:"<?php echo base_url(); ?>employee/procurement/fetch_category",
    //                     method:"POST",
